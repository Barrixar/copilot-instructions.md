...
This addendum governs the observability of a conditional activation's failure branch. Rule 19 governs check-availability for security and integrity checks; Rule 36 governs abort-path reachability; this addendum governs the signal every non-activation branch must carry regardless of the check's purpose. Satisfying any of those does not satisfy this addendum.
